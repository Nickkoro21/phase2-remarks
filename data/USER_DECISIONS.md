...
## 9. Σπασμένο glyph U+FFFF → «±» (ΑΠΑΝΤΗΘΗΚΕ 2026-08-08)

Στο πρωτότυπο Syllabus το σύμβολο «±» τυπώνεται σε αρκετούς πίνακες ως μη-ορισμένος χαρακτήρας U+FFFF (σφάλμα εκτύπωσης/γραμματοσειράς του εγγράφου, όχι διαφορετικό σύμβολο). **Απόφαση χρήστη:** κανονικοποίηση σε «±» παντού. Εφαρμόστηκε σε 384 εμφανίσεις στα criteria/*.json (raw + resolved πεδία). Τα αρχεία data/raw/ (αρχείο πιστής εξαγωγής) παραμένουν ως είχαν για ιχνηλασιμότητα.

---

## 10. Ζεύγη-σύνολα προσεγγίσεων στα minimums (ΑΠΑΝΤΗΘΗΚΕ 2026-08-08)

**Απόφαση χρήστη:** VOR/TACAN, ILS/LOC και GCA PAR/ASR λειτουργούν ως ΣΥΝΟΛΑ απαιτήσεων — όποιο μέλος του ζεύγους εκτελεστεί, καλύπτει το minimum. Το γενικό «Final approach» του I4490 καλύπτεται από οποιαδήποτε προσέγγιση. Το «Pitch out / Rejoin (Wingman)» είναι σύνθετο που καλύπτει Pitch Out/Spacing + Rejoins. Εφαρμόστηκε ως mif_sn_group σε 12 εγγραφές του data/minimums.json· στο MIF Progress chart εμφανίζονται με «*» και υποσημείωση shared-set.
